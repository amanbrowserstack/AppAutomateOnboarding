...
public class ChallengeTwo extends AppiumTest {
    ...
    public void testLocalContentAccess() throws Exception {
        ...
        // Save/Apply settings
        try {
            WebElement saveButton = driver.findElement(AppiumBy.xpath("//android.widget.Button[@text='Save'] | //android.widget.TextView[@text='Save']"));
            saveButton.click();
            System.out.println("Settings saved");
        } catch (Exception e) {
            System.out.println("No save button found, settings may auto-save");
        }
        ...
        for (int i = 0; i < 3; i++) {
            ...
            System.out.println("API call " + (i + 1) + " generated - check your terminal/dashboard");
        }
        
        Assert.assertTrue(true, "Local testing completed successfully");
    }
}